...
public class MyBookController {
     ...
     */
    @PostMapping
    public ResponseEntity<BasicResponse<String>> addBookToMyLibrary(@RequestParam(name = "isbn13") Long isbn13, @AuthenticationPrincipal CustomUserDetails userDetails) {
        if (userDetails == null || userDetails.getUser() == null) {
